      COMMON/ONE/IDIS(56,56),IFLOW(56,56)
      COMMON/TWO/IPAIR(56,56),ICOST(56,56,56,56),ICONST(56,56)
      COMMON/THREE/NUMP(3136),NUML(3136),IFREEP(56),IFREEL(56),IROW(56),
     /ICOL(56)
      COMMON/FOUR/IGILAW(56,56),C(56,56),IRSL(56)
      COMMON/FIVE/ICUR(56),IFIX1(56,2)
      INTEGER C
...
C     WRITE(6,*)M
      ...
      MTM=2*(M-1)
      WRITE(6,10)M
   10 FORMAT(T1,'NAME',T10,'NEWLP',I2.2)
...
CCCCCC THE CONSTRAINTS SUM OF X'S = 1
      DO 14 I=1,MTWO
         WRITE(6,13) I
   13 FORMAT(T3,'E',T5,'NX',I2.2)
   14 CONTINUE
CCCCCC THE CONSTRAINTS SUM OF Y'S = XKL
      DO 16 J=1,MM
      DO 16 I=1,MTM
         WRITE(6,15) I,J
   15 FORMAT(T3,'E',T5,'C',I2.2,'A',I3.3)
   16 CONTINUE
...
CCCCCC LIST THE X VARIALBLES
      ...
      DO 27 J=1,M
         ...
         WRITE(6,24)K,I,AT
         WRITE(6,24)K,MPJ,AT
   24 FORMAT(T5,'X',I3.3,T15,'NX',I2.2,T25,F3.1)
         DO 26 L=1,MTM
            WRITE(6,25)K,L,K,AAT
   25 FORMAT(T5,'X',I3.3,T15,'C',I2.2,'A',I3.3,T25,F4.1)
   26    CONTINUE
   27 CONTINUE
...
CCCCCC JJ<LL
   ...
   28 FORMAT(T5,'Y',I3.3,'A',I3.3,T15,'NOBJ',T25,F10.1)
               WRITE(6,29)IJ,KL,IHOLD,KL,AT
               WRITE(6,29)IJ,KL,IT,KL,AT
   29 FORMAT(T5,'Y',I3.3,'A',I3.3,T15,'C',I2.2,'A',I3.3,T25,F3.1)
               WRITE(6,30)IJ,KL,IRA,KLA,AT
               WRITE(6,30)IJ,KL,ITA,KLA,AT
   30 FORMAT(T5,'Y',I3.3,'A',I3.3,T15,'C',I2.2,'A',I3.3,T25,F3.1)
   33       CONTINUE
            GO TO 38
CCCCCC
   38     CONTINUE
...
CCCCCC GIVE THE RIGHT HAND SIDES OF THE CONSTRAINTS
   ...
   40 FORMAT(T1,'RHS')
      DO 42 I=1,MTWO
         WRITE(6,41) I,AT
   41 FORMAT(T5,'RHS',T15,'NX',I2.2,T25,F3.1)
   42 CONTINUE
      WRITE(6,43)
   43 FORMAT(T1,'ENDATA')               
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
